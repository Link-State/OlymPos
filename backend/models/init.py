...
command.execute("CREATE TABLE Store_info (unique_store_info INT, unique_admin INT NOT NULL, store_name VARCHAR(64) NOT NULL, store_owner VARCHAR(128) NOT NULL, store_address VARCHAR(256) NOT NULL, store_tel_number VARCHAR(16) NOT NULL, table_count INT NOT NULL, isLogin INT);")
...
command.execute("CREATE TABLE Product_Option_relations (unique_product INT NOT NULL, unique_product_option INT NOT NULL);")
...
command.execute("ALTER TABLE Product_Option_relations ADD PRIMARY KEY (unique_product, unique_product_option);")
command.execute("ALTER TABLE Product_Option_relations ADD FOREIGN KEY (unique_product) REFERENCES Product(unique_product) ON UPDATE CASCADE ON DELETE CASCADE;")
command.execute("ALTER TABLE Product_Option_relations ADD FOREIGN KEY (unique_product_option) REFERENCES Product_option(unique_product_option) ON UPDATE CASCADE ON DELETE CASCADE;")
